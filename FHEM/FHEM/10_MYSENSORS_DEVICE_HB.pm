...
# $Id: 10_MYSENSORS_DEVICE.pm 9385 2015-10-05 21:21:57Z ntruchsess $
#
##############################################
...
my %static_types = (
  ...
  S_TEMP                  => { receives => [V_VAR1], sends => [V_TEMP,V_ID,V_VAR1] }, # Temperature sensor
  S_HUM                   => { receives => [V_VAR1], sends => [V_HUM,V_VAR1] }, # Humidity sensor
